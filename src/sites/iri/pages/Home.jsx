    ...
    <>
      ...
      <section className="relative overflow-hidden bg-[#F4F6F8] pt-32 pb-20 sm:pt-40 sm:pb-28">
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          ...
          />
          <div className="absolute -right-40 -top-24 h-[34rem] w-[34rem] rounded-full bg-[#1C6DD0]/10 blur-3xl" />
          <div className="absolute -left-40 bottom-0 h-[26rem] w-[26rem] rounded-full bg-[#F0A93B]/10 blur-3xl" />
        </div>

        <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-6 lg:grid-cols-[1.1fr_0.9fr]">
          <div>
            <Reveal>
              <span className="inline-flex items-center gap-2 rounded-full border border-[#1C6DD0]/20 bg-white px-4 py-1.5 font-sans text-xs font-bold uppercase tracking-[0.14em] text-[#1C6DD0] shadow-sm">
                <span className="h-1.5 w-1.5 rounded-full bg-[#F0A93B]" /> Loja de referência · Lisboa
              </span>
            </Reveal>
            <Reveal delay={80}>
              <h1 className="mt-6 font-manrope text-4xl font-extrabold leading-[1.05] tracking-tight text-[#14202B] text-balance sm:text-5xl lg:text-6xl">
                ...
                <span className="text-[#1C6DD0]">Impermeabilização</span>.
              </h1>
            </Reveal>
            <Reveal delay={150}>
            ...
            <Reveal delay={220}>
              <div className="mt-9 flex flex-wrap items-center gap-4">
                <Link
                  ...
                  className="inline-flex items-center gap-2 rounded-lg bg-[#1C6DD0] px-7 py-3.5 font-sans text-base font-bold text-white shadow-lg shadow-[#1C6DD0]/25 transition-all duration-200 hover:bg-[#1559a8] hover:shadow-xl cursor-pointer"
                >
                  Pedir orçamento <ArrowRight className="h-4 w-4" />
                </Link>
                <a
                  href={brand.phoneStoreHref}
                  className="inline-flex items-center gap-2 rounded-lg border border-[#14202B]/15 bg-white px-7 py-3.5 font-sans text-base font-bold text-[#14202B] transition-colors duration-200 hover:border-[#1C6DD0]/40 hover:text-[#1C6DD0] cursor-pointer"
                >
            ...
            <Reveal delay={300}>
              <div className="mt-8 flex flex-wrap items-center gap-x-6 gap-y-3">
                <div className="flex items-center gap-2">
                  <div className="flex">
                    {[0, 1, 2, 3, 4].map((i) => (
                      <Star key={i} className="h-4 w-4 fill-[#F0A93B] text-[#F0A93B]" />
                    ))}
                  </div>
                ...
                <span className="inline-flex items-center gap-1.5 rounded-full bg-[#1C6DD0]/10 px-3 py-1 font-sans text-xs font-bold text-[#1C6DD0]">
          ...
          <Reveal delay={300} className="relative">
            <div className="relative overflow-hidden rounded-2xl bg-[#14202B] p-8 text-white shadow-2xl shadow-[#14202B]/25">
              <div className="absolute -right-10 -top-10 h-40 w-40 rounded-full bg-[#1C6DD0]/25 blur-2xl" />
              <div className="relative">
                ...
                <ul className="mt-6 space-y-3">
                  {['Gama técnica profunda', 'Aconselhamento especializado', 'Loja física em Lisboa'].map((t) => (
                    <li key={t} className="flex items-center gap-3 text-sm font-semibold">
                      <span className="grid h-6 w-6 place-items-center rounded-md bg-[#1C6DD0] text-white">
                ...
                <div className="mt-7 grid grid-cols-2 gap-4 border-t border-white/10 pt-5">
                  ...
                  <div>
                    <div className="font-manrope text-2xl font-extrabold text-[#F0A93B]">4,4★</div>
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-3">
              {partners.map((p, i) => (
                <Reveal key={p} delay={i * 50}>
                  <span className="rounded-lg border border-[#14202B]/10 bg-[#F4F6F8] px-4 py-2 font-manrope text-sm font-bold tracking-tight text-[#33424E] transition-colors hover:border-[#1C6DD0]/40 hover:text-[#1C6DD0]">
                    {p}
                  </span>
                </Reveal>
              ))}
          ...
          <div className="flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-end">
            ...
            <Reveal delay={120}>
              <Link
                ...
                className="inline-flex shrink-0 items-center gap-2 font-sans text-sm font-bold text-[#1C6DD0] transition-colors hover:text-[#14202B] cursor-pointer"
              >
              ...
              <Reveal key={p.title} delay={(i % 3) * 80}>
                <div
                  className={
                    ...
                    (p.highlight
                      ? 'border-[#1C6DD0]/30 bg-[#1C6DD0]/[0.04] hover:border-[#1C6DD0]/50'
                      : 'border-[#14202B]/10 bg-white hover:border-[#1C6DD0]/30')
                  }
                >
                  {p.highlight && (
                    <span className="absolute right-5 top-5 rounded-full bg-[#F0A93B] px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wide text-[#14202B]">
                      Loja
                    </span>
                  )}
                  <span className="inline-grid h-12 w-12 place-items-center rounded-xl bg-[#1C6DD0]/10 text-[#1C6DD0] transition-colors duration-300 group-hover:bg-[#1C6DD0] group-hover:text-white">
            ...
            {steps.map((s, i) => (
              <Reveal key={s.title} delay={i * 80}>
                <div className="relative h-full rounded-2xl border border-[#14202B]/10 bg-[#F4F6F8] p-7">
                  <span className="font-manrope text-sm font-extrabold text-[#1C6DD0]">
                    0{i + 1}
                  </span>
                  <span className="mt-4 inline-grid h-11 w-11 place-items-center rounded-xl bg-white text-[#1C6DD0] ring-1 ring-[#1C6DD0]/15">
              ...
              <Reveal key={g.seed} delay={(i % 3) * 80}>
                <figure className="group relative aspect-[4/3] overflow-hidden rounded-2xl border border-[#14202B]/10 bg-[#14202B]">
                  ...
                  <figcaption className="absolute inset-x-0 bottom-0 p-5">
                    <span className="inline-block rounded-full bg-[#1C6DD0] px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wide text-white">
                      {g.tag}
                    </span>
            ...
            <Reveal>
              <div className="rounded-3xl border border-[#14202B]/10 bg-[#F4F6F8] p-10 text-center">
                ...
                <div className="mt-3 flex justify-center">
                  {[0, 1, 2, 3, 4].map((i) => (
                    <Star key={i} className="h-6 w-6 fill-[#F0A93B] text-[#F0A93B]" />
                  ))}
                </div>
                <p className="mt-3 font-sans text-sm font-semibold text-[#51616E]">
                  {brand.reviews} avaliações no Google
                </p>
                <div className="mt-6 inline-flex items-center gap-2 rounded-full bg-[#1C6DD0]/10 px-4 py-2 font-sans text-sm font-bold text-[#1C6DD0]">
                ...
                {values.map((v, i) => (
                  <Reveal key={v.title} delay={i * 90}>
                    <div className="flex gap-4 rounded-2xl border border-[#14202B]/10 bg-white p-5">
                      <span className="inline-grid h-11 w-11 shrink-0 place-items-center rounded-xl bg-[#1C6DD0]/10 text-[#1C6DD0]">
      ...
      <section className="relative overflow-hidden bg-[#14202B] py-20">
        <div className="pointer-events-none absolute inset-0">
          ...
          />
          <div className="absolute -left-20 top-0 h-72 w-72 rounded-full bg-[#1C6DD0]/20 blur-3xl" />
          <div className="absolute -right-10 bottom-0 h-72 w-72 rounded-full bg-[#F0A93B]/15 blur-3xl" />
        </div>
        <div className="relative mx-auto flex max-w-5xl flex-col items-center gap-8 px-6 text-center">
          <Reveal>
            <span className="inline-flex items-center gap-2 rounded-full border border-white/15 px-4 py-1.5 font-sans text-xs font-bold uppercase tracking-[0.14em] text-[#F0A93B]">
          ...
          <Reveal delay={120}>
            <div className="flex flex-wrap items-center justify-center gap-4">
              <a
                ...
                className="inline-flex items-center gap-2 rounded-lg bg-[#1C6DD0] px-8 py-4 font-sans text-base font-bold text-white transition-all duration-200 hover:bg-[#1559a8] hover:scale-[1.02] cursor-pointer"
              >
