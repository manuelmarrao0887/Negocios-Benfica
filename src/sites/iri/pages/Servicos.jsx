          ...
          {services.map((s, i) => (
            <Reveal key={s.title} delay={(i % 2) * 80}>
              <div className="grid gap-8 rounded-3xl border border-[#14202B]/10 bg-[#F4F6F8] p-8 sm:p-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
                <div>
                  <span className="inline-grid h-14 w-14 place-items-center rounded-2xl bg-[#1C6DD0] text-white shadow-sm shadow-[#1C6DD0]/30">
                ...
                <ul className="grid gap-3 sm:grid-cols-2">
                  {s.points.map((pt) => (
                    ...
                    >
                      <span className="mt-0.5 grid h-5 w-5 shrink-0 place-items-center rounded-md bg-[#1C6DD0]/10 text-[#1C6DD0]">
        ...
        <div className="mx-auto max-w-7xl px-6">
          <Reveal>
            <div className="relative overflow-hidden rounded-3xl bg-[#14202B] px-8 py-12 sm:px-14 sm:py-16">
              <div className="pointer-events-none absolute -right-16 -top-16 h-64 w-64 rounded-full bg-[#1C6DD0]/20 blur-3xl" />
              <div className="pointer-events-none absolute -left-16 -bottom-16 h-64 w-64 rounded-full bg-[#F0A93B]/10 blur-3xl" />
              <div className="relative grid items-center gap-10 lg:grid-cols-[1.2fr_0.8fr]">
                <div>
                  <span className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-1.5 font-sans text-xs font-bold uppercase tracking-wider text-[#F0A93B]">
                  ...
                  <div className="mt-7 flex flex-wrap items-center gap-4">
                    <a
                      ...
                      className="inline-flex items-center gap-2 rounded-lg bg-[#1C6DD0] px-7 py-3.5 font-sans text-base font-bold text-white transition-all duration-200 hover:bg-[#1559a8] hover:scale-[1.02] cursor-pointer"
                    >
                ...
                <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
                  <p className="flex items-center gap-2 font-sans text-xs font-bold uppercase tracking-[0.14em] text-[#F0A93B]">
