...
export default function Contacto() {
  ...
  return (
    <>
      ...
      {/* Info cards */}
      <section className="border-t border-white/[0.06] bg-[#0d1526] pb-6 pt-12">
            ...
            return (
              <Reveal key={c.label} delay={i * 70}>
                <Tag
                  ...
                  className={
                    'flex h-full flex-col gap-3 rounded-2xl border border-white/[0.07] bg-[#131C2E] p-6 ' +
                    (c.href
                ...
                >
                  <span className="inline-grid h-11 w-11 place-items-center rounded-xl bg-[#0B1220] text-[#2E7DF6] ring-1 ring-[#2E7DF6]/25">
                    <c.icon className="h-5 w-5" />
                  </span>
                  <div>
                    <p className="text-xs font-bold uppercase tracking-wide text-[#6c7d96]">{c.label}</p>
                    <p className="mt-1 break-words font-space font-bold text-[#E8EEF7]">{c.value}</p>
                  </div>
                </Tag>
              </Reveal>
            )
      ...
      {/* Hours + travel note */}
      <section className="bg-[#0d1526] pb-12 pt-6">
        <div className="mx-auto grid max-w-7xl gap-5 px-6 sm:grid-cols-2">
          <Reveal>
            <div className="flex h-full items-start gap-4 rounded-2xl border border-white/[0.07] bg-[#131C2E] p-6">
              <span className="inline-grid h-11 w-11 shrink-0 place-items-center rounded-xl bg-[#18C29C]/10 text-[#18C29C]">
                <Clock className="h-5 w-5" />
              </span>
              <div>
                <p className="text-xs font-bold uppercase tracking-wide text-[#6c7d96]">Horário</p>
                <p className="mt-1 font-space font-bold text-[#E8EEF7]">{brand.hours}</p>
                <p className="mt-0.5 text-sm text-[#93A4BC]">{brand.hoursWeekend}</p>
              </div>
            </div>
          </Reveal>
          <Reveal delay={80}>
            <div className="flex h-full items-start gap-4 rounded-2xl border border-white/[0.07] bg-[#131C2E] p-6">
              ...
              <div>
                <p className="text-xs font-bold uppercase tracking-wide text-[#6c7d96]">Deslocação</p>
                <p className="mt-1 font-space font-bold text-[#E8EEF7]">Taxa de deslocação na zona de Lisboa</p>
                <p className="mt-0.5 text-sm text-[#93A4BC]">Acréscimo para zonas mais distantes.</p>
              </div>
            </div>
          </Reveal>
        </div>
      ...
      <section className="bg-[#0d1526] py-16">
        <div className="mx-auto grid max-w-7xl gap-10 px-6 lg:grid-cols-2">
          {/* Form */}
          <Reveal>
            <div className="rounded-3xl border border-white/[0.07] bg-[#131C2E] p-8 sm:p-10">
              <h2 className="font-space text-2xl font-bold text-[#E8EEF7]">Descrever a avaria</h2>
              <p className="mt-2 text-sm text-[#93A4BC]">
                Conte-nos a marca da TV e o que está a acontecer. Respondemos o mais rápido possível.
              </p>
              {sent ? (
                <div className="mt-8 flex flex-col items-center gap-4 rounded-2xl border border-[#18C29C]/30 bg-[#0B1220] p-10 text-center">
                  <span className="grid h-14 w-14 place-items-center rounded-full bg-[#18C29C] text-[#0B1220]">
                    <Check className="h-7 w-7" strokeWidth={3} />
                  </span>
                  <p className="font-space text-xl font-bold text-[#E8EEF7]">Mensagem enviada!</p>
                  <p className="text-sm text-[#93A4BC]">
                ...
                >
                  ...
                  <div>
                    <label htmlFor="mensagem" className="mb-2 block font-sans text-sm font-bold text-[#E8EEF7]">
                      Descrição da avaria
                    </label>
                    <textarea
                      id="mensagem"
                      ...
                      className="w-full rounded-xl border border-white/10 bg-[#0B1220] px-4 py-3 font-sans text-[#E8EEF7] outline-none transition-colors placeholder:text-[#6c7d96] focus:border-[#2E7DF6] focus:ring-2 focus:ring-[#2E7DF6]/30"
                    />
                  </div>
                  <button
                    type="submit"
                  ...
                  <p className="text-center text-xs text-[#6c7d96]">
          ...
          <Reveal delay={120}>
            <div className="flex h-full flex-col gap-5">
              ...
              <a
                ...
                className="flex items-center justify-between gap-4 rounded-2xl border border-[#2E7DF6]/30 bg-gradient-to-r from-[#15233d] to-[#131C2E] p-6 transition-colors hover:border-[#2E7DF6]/50 cursor-pointer"
              >
                <div>
                  <p className="text-xs font-bold uppercase tracking-wide text-[#93A4BC]">Apoio técnico por telefone</p>
                  <p className="mt-1 font-space text-xl font-bold text-[#E8EEF7]">{brand.phoneDisplay}</p>
                </div>
...
function Field({ id, label, type = 'text', placeholder, required = true }) {
  return (
    <div>
      <label htmlFor={id} className="mb-2 block font-sans text-sm font-bold text-[#E8EEF7]">
        {label}
      </label>
      <input
        id={id}
