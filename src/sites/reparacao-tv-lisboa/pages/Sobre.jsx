    ...
    <>
      ...
      <section className="border-t border-white/[0.06] bg-[#0d1526] py-20">
        <div className="mx-auto grid max-w-7xl items-center gap-14 px-6 lg:grid-cols-2">
          <Reveal>
            <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-[#15233d] to-[#0e1730] p-10">
              <Quote className="h-10 w-10 text-[#2E7DF6]" />
              <p className="mt-6 font-space text-2xl font-semibold leading-snug text-[#E8EEF7]">
              ...
              <div className="mt-8 flex items-center gap-4 border-t border-white/10 pt-6">
                ...
                <div>
                  <p className="font-sans font-bold text-[#E8EEF7]">Narciso Silva</p>
                  <p className="text-sm text-[#93A4BC]">Técnico de Eletrónica</p>
                </div>
              </div>
            </div>
          </Reveal>
          <div>
            <Reveal>
              <p className="text-pretty text-lg leading-relaxed text-[#93A4BC]">
                A carreira de Narciso Silva começou em <span className="text-[#E8EEF7]">1990</span>, como
                Técnico de Eletrónica na <span className="text-[#E8EEF7]">Samsung Electrónica Portuguesa</span>.
            ...
            <Reveal delay={120}>
              <p className="mt-5 text-pretty text-lg leading-relaxed text-[#93A4BC]">
                Foram <span className="text-[#E8EEF7]">35 anos</span> a aprofundar o conhecimento dos
              ...
              <div className="mt-9 grid grid-cols-2 gap-6 sm:grid-cols-4">
                {stats.map((s) => (
                  <div key={s.label}>
                    ...
                    <div className="mt-1 text-xs font-semibold uppercase tracking-wide text-[#6c7d96]">
                      {s.label}
                    </div>
                  </div>
                ))}
          ...
          <div className="relative mt-16 grid gap-6 md:grid-cols-3">
            ...
            {timeline.map((t, i) => (
              <Reveal key={t.title} delay={i * 110}>
                <div className="h-full rounded-2xl border border-white/[0.07] bg-[#131C2E] p-7">
                  <div className="flex items-center justify-between">
                    <span className="grid h-12 w-12 place-items-center rounded-xl bg-[#0B1220] text-[#2E7DF6] ring-1 ring-[#2E7DF6]/30">
                      <t.icon className="h-6 w-6" strokeWidth={1.8} />
                    </span>
                    <span className="font-space text-sm font-bold uppercase tracking-wider text-[#18C29C]">
                      {t.year}
                    </span>
                  </div>
                  <h3 className="mt-5 font-space text-lg font-bold leading-snug text-[#E8EEF7]">{t.title}</h3>
                  <p className="mt-2 text-sm leading-relaxed text-[#93A4BC]">{t.desc}</p>
                </div>
              </Reveal>
            ))}
          </div>
          ...
          <Reveal>
            <div className="relative overflow-hidden rounded-3xl border border-white/10">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                <span className="inline-flex items-center gap-2 rounded-full bg-[#18C29C]/15 px-4 py-1.5 font-sans text-xs font-bold uppercase tracking-wider text-[#18C29C] ring-1 ring-[#18C29C]/30">
                  <ShieldCheck className="h-4 w-4" /> 100% recomendado · Facebook
                </span>
                <p className="mt-3 font-space text-xl font-bold text-[#E8EEF7]">
          ...
          <div>
            <Reveal>
              ...
              <p className="mt-4 max-w-lg text-lg leading-relaxed text-[#93A4BC]">
                ...
                <span className="text-[#E8EEF7]">100% recomendado</span>, com base em 6 avaliações de
                clientes. É o reflexo de um atendimento próximo e de uma garantia que se cumpre.
              </p>
            </Reveal>
            <Reveal delay={120}>
              <div className="mt-8 grid grid-cols-2 gap-4">
                <div className="rounded-2xl border border-white/[0.07] bg-[#131C2E] p-6">
                  <div className="font-space text-3xl font-bold text-[#2E7DF6]">100%</div>
                  <p className="mt-1 text-sm text-[#93A4BC]">recomendado no Facebook</p>
                </div>
                <div className="rounded-2xl border border-white/[0.07] bg-[#131C2E] p-6">
                  <div className="font-space text-3xl font-bold text-[#2E7DF6]">6</div>
                  <p className="mt-1 text-sm text-[#93A4BC]">avaliações de clientes</p>
                </div>
              </div>
            </Reveal>
          </div>
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-3">
            {values.map((v, i) => (
              <Reveal key={v.title} delay={i * 90}>
                <div className="h-full rounded-2xl border border-white/[0.07] bg-[#131C2E] p-8">
                  ...
                  <h3 className="mt-5 font-space text-xl font-bold text-[#E8EEF7]">{v.title}</h3>
                  <p className="mt-2 text-sm leading-relaxed text-[#93A4BC]">{v.text}</p>
                </div>
              </Reveal>
            ))}
          </div>
