    ...
    <>
      ...
      <section className="relative overflow-hidden bg-[#F4F6F9] pt-32 pb-20 sm:pt-40 sm:pb-28">
        <div className="pointer-events-none absolute inset-0">
          ...
          <div className="absolute -right-32 -top-24 h-[34rem] w-[34rem] rounded-full bg-[#1A56DB]/10 blur-3xl" />
          <div className="absolute -left-32 bottom-0 h-[26rem] w-[26rem] rounded-full bg-[#2FA39B]/10 blur-3xl" />
        </div>

        <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-6 lg:grid-cols-[1.1fr_0.9fr]">
          <div>
            <Reveal>
              <span className="inline-flex items-center gap-2 rounded-md border border-[#10161D]/15 bg-white px-3.5 py-1.5 font-plexmono text-[11px] font-semibold uppercase tracking-[0.18em] text-[#10161D]">
                <span className="h-1.5 w-1.5 bg-[#1A56DB]" /> Eletrónica Industrial · Lisboa
              </span>
            </Reveal>
            <Reveal delay={80}>
              <h1 className="mt-6 font-plex text-5xl font-bold leading-[1.04] tracking-tight text-[#10161D] text-balance sm:text-6xl">
            ...
            <Reveal delay={220}>
              <div className="mt-9 flex flex-wrap items-center gap-4">
                <Link
                  ...
                  className="inline-flex items-center gap-2 rounded-md bg-[#1A56DB] px-7 py-3.5 font-plex text-base font-bold text-white shadow-lg shadow-[#1A56DB]/25 transition-all duration-200 hover:bg-[#1648b8] hover:shadow-xl cursor-pointer"
                >
                  Pedir assistência <ArrowRight className="h-4 w-4" />
                </Link>
                <a
                  href={brand.phoneHref}
                  className="inline-flex items-center gap-2 rounded-md border border-[#10161D]/20 bg-white px-7 py-3.5 font-plex text-base font-bold text-[#10161D] transition-colors duration-200 hover:border-[#10161D]/40 hover:bg-[#10161D]/[0.03] cursor-pointer"
                >
          ...
          <Reveal delay={300} className="relative">
            <div className="relative overflow-hidden rounded-xl bg-[#10161D] p-8 text-[#F4F6F9] shadow-2xl shadow-[#10161D]/30">
              <GridField className="absolute inset-0" tone="#FFFFFF" opacity={0.05} />
              <div className="pointer-events-none absolute -right-10 -top-10 h-40 w-40 rounded-full bg-[#1A56DB]/25 blur-2xl" />
              <div className="relative">
                <div className="flex items-center justify-between">
                  <span className="font-plexmono text-[11px] uppercase tracking-[0.2em] text-[#2FA39B]">
                    Capacidade técnica
                  </span>
                  <Activity className="h-5 w-5 text-[#2FA39B]" />
                </div>
                ...
                <ul className="mt-6 space-y-3">
                  {[
                    ...
                    <li key={t} className="flex items-center gap-3 text-sm font-medium">
                      <span className="grid h-6 w-6 shrink-0 place-items-center rounded bg-[#1A56DB] text-white">
                ...
                <div className="mt-7 grid grid-cols-2 gap-px overflow-hidden rounded-lg border border-white/10 bg-white/10 text-center">
                  <div className="bg-[#10161D] px-3 py-4">
      ...
      {/* ── Capability strip ─────────────────────────────────────────── */}
      <section className="border-y border-[#10161D]/10 bg-white">
        <div className="mx-auto grid max-w-7xl grid-cols-2 gap-px overflow-hidden px-6 lg:grid-cols-4">
          {capabilities.map((c, i) => (
            <Reveal key={c.title} delay={i * 70} className="px-2 py-8 sm:px-6">
              <div className="flex items-center justify-between">
                <c.icon className="h-7 w-7 text-[#1A56DB]" strokeWidth={1.6} />
                <span className="font-plexmono text-[10px] font-medium uppercase tracking-[0.14em] text-[#9DAAB8]">
                  {c.code}
                </span>
              </div>
              <h3 className="mt-4 font-plex text-lg font-bold text-[#10161D]">{c.title}</h3>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-end">
            <Reveal>
              ...
              <h2 className="mt-3 max-w-2xl font-plex text-4xl font-bold leading-tight text-[#10161D] sm:text-5xl">
            ...
            <Reveal delay={120}>
              <Link
                ...
                className="inline-flex shrink-0 items-center gap-2 font-plex text-sm font-bold text-[#10161D] transition-colors hover:text-[#1A56DB] cursor-pointer"
              >
          ...
          <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {solutions.map((s, i) => (
              <Reveal key={s.title} delay={(i % 3) * 80}>
                <div className="group h-full rounded-xl border border-[#10161D]/10 bg-white p-7 transition-all duration-300 hover:-translate-y-1 hover:border-[#1A56DB]/40 hover:shadow-xl hover:shadow-[#10161D]/5">
                  <div className="flex items-start justify-between">
                    <span className="inline-grid h-12 w-12 place-items-center rounded-md bg-[#10161D]/[0.05] text-[#10161D] transition-colors duration-300 group-hover:bg-[#1A56DB] group-hover:text-white">
                      <s.icon className="h-6 w-6" strokeWidth={1.6} />
                    </span>
                    <span className="rounded border border-[#10161D]/10 px-2 py-1 font-plexmono text-[10px] font-semibold uppercase tracking-[0.14em] text-[#4C5A68]">
                      {s.code}
                    </span>
                  </div>
                  <h3 className="mt-5 font-plex text-xl font-bold text-[#10161D]">{s.title}</h3>
      ...
      <section className="relative overflow-hidden bg-[#10161D] py-24 text-[#F4F6F9]">
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          ...
          <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {sectors.map((s, i) => (
              <Reveal key={s.title} delay={(i % 3) * 80}>
                <div className="group flex h-full items-start gap-4 rounded-xl border border-white/10 bg-white/[0.03] p-6 transition-colors duration-300 hover:border-[#2FA39B]/40 hover:bg-white/[0.06]">
                  <span className="inline-grid h-11 w-11 shrink-0 place-items-center rounded-md bg-[#1A56DB]/15 text-[#2FA39B]">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-14 px-6 lg:grid-cols-2">
          <Reveal>
            <div className="relative overflow-hidden rounded-xl border border-[#10161D]/10">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#10161D]/80 via-[#10161D]/10 to-transparent" />
              <div className="absolute bottom-0 left-0 p-8">
                <span className="font-plexmono text-[11px] uppercase tracking-[0.18em] text-[#2FA39B]">
                  Oficina & Terreno
                </span>
          ...
          <div>
            ...
            <Reveal delay={180}>
              <ul className="mt-8 space-y-3">
                {[
                  ...
                  <li key={t} className="flex items-start gap-3 text-[15px] text-[#10161D]">
                    <span className="mt-0.5 grid h-6 w-6 shrink-0 place-items-center rounded bg-[#1A56DB]/10 text-[#1A56DB]">
            ...
            <Reveal delay={240}>
              <Link
                to={siteLink(slug, 'solucoes')}
                className="mt-9 inline-flex items-center gap-2 rounded-md border border-[#10161D]/20 px-6 py-3 font-plex text-sm font-bold text-[#10161D] transition-colors hover:border-[#1A56DB]/50 hover:text-[#1A56DB] cursor-pointer"
              >
      ...
      <section className="bg-[#F4F6F9] py-24">
        <div className="mx-auto grid max-w-7xl items-center gap-14 px-6 lg:grid-cols-2">
          <Reveal>
            <div className="relative overflow-hidden rounded-xl bg-[#10161D] p-10">
              <GridField className="absolute inset-0" tone="#FFFFFF" opacity={0.05} />
              <div className="relative flex h-full flex-col justify-between">
                <Cpu className="h-10 w-10 text-[#2FA39B]" strokeWidth={1.4} />
                <div className="mt-10">
          ...
          <div>
            ...
            <Reveal delay={180}>
              <div className="mt-8 grid grid-cols-2 gap-px overflow-hidden rounded-lg border border-[#10161D]/10 bg-[#10161D]/10 sm:grid-cols-4">
                {stats.map((s) => (
                  <div key={s.label} className="bg-[#F4F6F9] px-4 py-5">
                    <div className="font-plexmono text-2xl font-semibold text-[#10161D]">{s.value}</div>
      ...
      {/* ── CTA band ─────────────────────────────────────────────────── */}
      <section className="relative overflow-hidden bg-[#1A56DB] py-20">
        ...
        <div className="pointer-events-none absolute inset-0">
          ...
          <div className="absolute -right-10 bottom-0 h-72 w-72 rounded-full bg-[#2FA39B]/25 blur-3xl" />
        </div>
        <div className="relative mx-auto flex max-w-5xl flex-col items-center gap-8 px-6 text-center">
          ...
          <Reveal delay={120}>
            <div className="flex flex-wrap items-center justify-center gap-4">
              <a
                href={brand.phoneHref}
                className="inline-flex items-center gap-2 rounded-md bg-white px-8 py-4 font-plex text-base font-bold text-[#1A56DB] transition-transform duration-200 hover:scale-[1.02] cursor-pointer"
              >
